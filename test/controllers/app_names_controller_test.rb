...
class AppNamesControllerTest < ActionController::TestCase
  ...
  test "should create app_name" do
    assert_difference('AppName.count') do
      post :create, app_name: { directions: @app_name.directions, players: @app_name.players, title: @app_name.title }
    end
  ...
  test "should update app_name" do
    patch :update, id: @app_name, app_name: { directions: @app_name.directions, players: @app_name.players, title: @app_name.title }
    assert_redirected_to app_name_path(assigns(:app_name))
  end
